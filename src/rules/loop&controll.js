	...
	function (o, state, err) {
		if (o.type === 'ForStatement' || o.type === 'DoWhileStatement') {
			err.push({
				...
				desc: 'De andra looptyperna är svårare att läsa och är while-loopar med extra syntax',
				score: 900
			});
		}
	},
	...
	function (o, state, err) {
		if (o.type === 'BlockStatement' && o.body.length === 0) {
			err.push({
				...
				desc: 'Om det är en if/else-if sats, så negera logiken. Annars om syfte saknas så ta bort detta block!.',
				score: 9000
			});
		}
	}
